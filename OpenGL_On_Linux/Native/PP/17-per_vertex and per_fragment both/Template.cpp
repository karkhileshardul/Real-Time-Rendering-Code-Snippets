				...
				case KeyPress: 
					...
					switch(keySym)
					{
						case XK_Escape:
							...
							break;
						case XK_Q: case XK_q:// Q key for quit
							bDone=true;
							break;
						case XK_L:
						case XK_l://L for Light
							...
							break;
						case XK_V: case XK_v: //'V' for Vertex
							...
							break;
						case XK_F: case XK_f: //'F' for Fragment
...
void CreateWindow(void)
{
	...
	XStoreName(gpDisplay,gWindow,"17-Sphere_PerVertex and PerFragment Window");
