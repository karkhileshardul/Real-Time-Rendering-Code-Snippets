...
HRESULT initialize(void) {
	...
	hr = LoadD3DTexture(L"checkerboard.bmp", &gpID3D11ShaderResourceView_Texture_Square);
	if (FAILED(hr))
	{
		fopen_s(&gpFile, gszLogFileName, "a+");
...
void display(void)
{
	...
	XMMATRIX translation = XMMatrixTranslation(0.0f, 0.0f, 5.0f);
