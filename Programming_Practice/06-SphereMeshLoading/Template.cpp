...
#define SPHERE_X_TRANSLATE		0.0f
#define SPHERE_Y_TRANSLATE		-0.0f
#define SPHERE_Z_TRANSLATE		-5.0f

#define SPHERE_X_SCALE_FACTOR	0.5f
#define	SPHERE_Y_SCALE_FACTOR	0.5f
#define SPHERE_Z_SCALE_FACTOR	0.5f

#define START_ANGLE_POS				0.0f
#define END_ANGLE_POS				360.0f
#define SPHERE_ANGLE_INCREMENT		0.01f
...
int WINAPI WinMain(HINSTANCE hInstance,HINSTANCE hPrevInstance,LPSTR lpCmdLine,int nShowCmd){
	...
	static TCHAR szAppName[]=TEXT("06-Sphere Mesh loading");
	HWND hwnd=NULL;
	HBRUSH hBrush=NULL;
	...
	hwnd=CreateWindowEx(WS_EX_APPWINDOW,szAppName,szAppName,
						WS_OVERLAPPEDWINDOW |WS_CLIPCHILDREN |WS_CLIPSIBLINGS | WS_VISIBLE,
						WIN_INIT_X,WIN_INIT_Y,WIN_WIDTH,WIN_HEIGHT,
...
void initialize(void){
	...
	g_fp_logfile=fopen("SPHERE.LOG","w");
	if(!g_fp_logfile){
		uninitialize();
	}
...
void LoadMeshData(void){
	...
	g_fp_meshfile=fopen("Sphere2.OBJ","r");
	if(!g_fp_meshfile){
		uninitialize();
	}
	char *sep_space=" ";
...
void update(void){
	g_rotate=g_rotate+ SPHERE_ANGLE_INCREMENT;
...
void display(void){
	...
	glTranslatef(SPHERE_X_TRANSLATE,SPHERE_Y_TRANSLATE,SPHERE_Z_TRANSLATE);
	glRotatef(g_rotate,0.0f,1.0f,0.0f);
	glScalef(SPHERE_X_SCALE_FACTOR,SPHERE_Y_SCALE_FACTOR,SPHERE_Z_SCALE_FACTOR);
