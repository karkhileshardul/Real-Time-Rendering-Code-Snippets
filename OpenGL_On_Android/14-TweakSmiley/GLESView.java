package com.astromedicomp.win_tweak_smiley;
...
public class GLESView extends GLSurfaceView
    ...
    public void display(){
        ...
        float quad_texture[]=new float[8];
        ...
        GLES30.glBindVertexArray(vao_square[0]);
            ...
            GLES30.glBindBuffer(GLES30.GL_ARRAY_BUFFER,vbo_square_texture[0]);
        		...
        		ByteBuffer byteBuffer=ByteBuffer.allocateDirect(quad_texture.length * 4);
            	byteBuffer.order(ByteOrder.nativeOrder());
        		FloatBuffer verticesBuffer=byteBuffer.asFloatBuffer();
    	        verticesBuffer.put(quad_texture);
	            verticesBuffer.position(0);
            	GLES30.glBufferData(GLES30.GL_ARRAY_BUFFER,
                                	8*4,
                                	verticesBuffer,
