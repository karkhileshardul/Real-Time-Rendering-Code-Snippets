package com.astromedicomp.win_blackandwhite_tri_squ;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener,OnDoubleTapListener{
	...
	private void initialize(GL10 gl){
		...
		GLES30.glGenBuffers(1,vbo_square_color ,0);
		GLES30.glBindBuffer(GLES30.GL_ARRAY_BUFFER,vbo_square_color[0]);
		...
		verticesBuffer=byteBuffer.asFloatBuffer();//
		verticesBuffer.put(squareColors);
		verticesBuffer.position(0);

		GLES30.glBufferData(GLES30.GL_ARRAY_BUFFER,squareColors.length*4,
							verticesBuffer,GLES30.GL_STATIC_DRAW);
