...
int WINAPI WinMain(HINSTANCE hInstance,HINSTANCE hPrevInstance,
	...
	MSG msg;
	TCHAR szClassName[]=TEXT("06-BlackandWhite Triangle&Square Window");
	HWND hwnd;
	bool bDone=false;
	...
	if(fopen_s(&gpFile,"Log_SSK file.txt","w")!=0){
		MessageBox(NULL,TEXT("Log File cannot be created\n Exitting NOW..."),
				TEXT("!!!ERROR!!!"),MB_OK | MB_TOPMOST | MB_ICONSTOP);
		exit(EXIT_FAILURE);
	}else{
		fprintf(gpFile,"Log FIle created Successfully Opened!!\n");
	}
