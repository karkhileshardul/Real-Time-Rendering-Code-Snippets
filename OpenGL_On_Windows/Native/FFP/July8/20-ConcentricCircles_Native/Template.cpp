...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	HWND hwnd;
	MSG msg;
	TCHAR szClassName[] = TEXT("20-ConcentricCircles_Native");
	bool bDone = false;
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szClassName,
		TEXT("20-ConcentricCircles_Native Window"),
...
{
	//function prototypes
	void DrawConcentricCircles(GLfloat, color_t);
	...
	color_t color_array[] = {
		...
		{ 1.0f,0.52f,0.0f },//orange color
		{ 0.5f,0.5f,0.5f }, //gray color
		{ 0.53f,1.0f,0.75 } //light green
	};
	GLint i = 0;
	...
	for (i = 0; i < 10; i++) {
		DrawConcentricCircles(x, color_array[i]);
		x = x + 0.09;
	}
...
void DrawConcentricCircles(GLfloat r, color_t circle_color)
{
	//code
	glLineWidth(1.0f);
	...
	glColor3f(circle_color.red, circle_color.green, circle_color.blue);
