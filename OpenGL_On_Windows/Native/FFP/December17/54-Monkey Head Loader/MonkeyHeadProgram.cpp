...
#define VK_F						0x46 /*Vitual Key code for F */
#define VK_f 						0x60 /*Virtual key code for f*/
...
GLfloat g_rotate=0.00001f;

std::vector<std::vector<float>> g_vertices; /* Vector of vector of floats to hold vertex data */
std::vector<std::vector<float>> g_texture; /* Vector of vector of floats to hold texture data */
std::vector<std::vector<float>> g_normals; /* Vector of vector of floats to hold normals data */
